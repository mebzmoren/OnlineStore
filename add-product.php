  ...
  if(isset($_POST['submit'])) {
    ...
    if($result) {
      if (mysqli_num_rows($result) > 0) {
        ...
        $insert = "INSERT INTO product(seller_id, name, image, category, description, quantity, price, colors, sizes) VALUES('$seller_id', '$name', '$fileNameNew', '$category_id', '$description', '$quantity','$price', '$color_implode', '$sizes_implode')";
